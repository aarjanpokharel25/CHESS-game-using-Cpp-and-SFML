        ...
        while (window.pollEvent(e)) { 
            ...
            if (e.type == sf::Event::MouseButtonPressed) { 
                if (e.mouseButton.button == sf::Mouse::Left) { 
                    ...
                    // 4. CRITICAL FIX: Convert fullscreen screen pixels back into your 1100x800 layout coordinates
                    ...
                    // 5. You can now use your clean, original logic numbers!
                    ...
                    // Original button coordinates work perfectly now too
                    if (mouseX >= 850 && mouseX <= 1024 && mouseY >= 5 && mouseY <= 55) { 
                        chess = Game(sf::Color(0xf1e8daff), sf::Color(0x64bfa4ff));
                    } 
                } 
            } 
        } 
